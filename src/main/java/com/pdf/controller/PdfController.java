...
public class PdfController {
	...
	@PostMapping("/generate-dynamic-pdf")
	public ResponseEntity<Resource> generateDynamicPDF(@RequestBody InputData inputData) throws DocumentException, IOException {
